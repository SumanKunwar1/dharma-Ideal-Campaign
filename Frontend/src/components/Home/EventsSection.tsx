...
const events = [
  {
    ...
    description:
      "Celebrating individuals and organizations contributing to global spiritual progress.",
    date: "Coming Soon",
  ...
  },
  {
    ...
    description:
      "A reflective journey into deep philosophical and spiritual inquiries.",
    date: "Monthly Events",
  ...
  },
  {
    ...
    title: "Dharma Tune",
    description:
      "Sacred melodies designed to inspire meditation, peace, and inner harmony.",
  ...
  },
  {
    ...
    description:
      "Honoring exceptional women who embody compassion, leadership, and wisdom.",
    date: "Annual Event",
    location: "Nepal",
    featured: false,
  },
  {
    ...
    description:
      "A global spiritual gathering focused on empowerment, compassion, and purification practices.",
    date: "2024",
        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          <div className="text-center max-w-3xl mx-auto mb-16">
            ...
            <p className="text-muted-foreground text-lg">
              Participate in transformative events that nurture the soul and
